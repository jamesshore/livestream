...
describe("Media Object CSS", function() {
	...
	let frame;      // The Quixote test frame.
	let media;      // The media object element.
	let figure;     // The figure element inside the media object. (The icon.)
	let content;    // The content element inside the media object. (The paragraph.)
	...
	it("positions subsequent elements below media object", function() {
		...
		let subsequent = frame.add("<div>subsequent element</div>", "subsequent");
