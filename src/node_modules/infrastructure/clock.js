...
module.exports = class Clock {
	...
	static create() {
		...
		return new Clock({
			...
			advanceNullTimersAsync() { throw new Error("Can't advance the clock because it isn't a null clock"); }
		});
	}
	...
	async advanceNullTimersAsync(milliseconds) {
		ensure.signature(arguments, []);
		await this._globals.advanceNullTimersAsync();
	}
